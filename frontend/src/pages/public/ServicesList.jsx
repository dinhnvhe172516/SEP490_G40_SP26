            ...
            <div className="bg-gray-50 min-h-screen py-8">
                ...
                <div className="max-w-7xl mx-auto px-4">
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
                        <div>
                            <h1 className="text-3xl font-bold text-gray-900">Dịch vụ tại DCMS</h1>
                            <p className="text-gray-600 mt-2">Đội ngũ bác sĩ tận tâm, công nghệ hiện đại cho nụ cười hoàn mỹ</p>
                        </div>
                            ...
                            {services.map((service) => (
                                ...
                                >
                                    <div className="aspect-[4/3] overflow-hidden bg-gray-100 relative">
                                        <img
                                            src={service.icon || 'https://via.placeholder.com/400x300.png?text=Service'}
                                        ...
                                        <div className="absolute top-3 right-3">
                                            <span className="bg-white/90 backdrop-blur-sm px-3 py-1 rounded-full text-xs font-bold text-primary-700 shadow-sm">
                                                {service.duration ? `${service.duration} phút` : 'Tư vấn'}
                                            </span>
                                        </div>
                                    </div>
                                    ...
                                    <div className="p-5 flex-1 flex flex-col">
                                        ...
                                        <p className="text-gray-600 text-sm line-clamp-3 mb-4 flex-1">
                                            {service.description || 'Chăm sóc sức khỏe răng miệng chuyên nghiệp với công nghệ hiện đại nhất hiện nay.'}
                                        </p>
